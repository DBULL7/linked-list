...
bookmark.prototype.createHtml = function () {
  return '<article class="site-card" <h2 class="card-title">'+this.title+'</h2> <hr> class="card-url" href='+this.url+'>'+ this.url+'</p> <hr> <a class="card-read">Read</a> <a class="card-delete">Delete</a> </article>'
}
